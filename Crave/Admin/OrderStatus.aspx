<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="Crave.Admin.OrderStatus" %>
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <asp:Repeater ID="rOrderStatus" runat="server" OnItemCommand="rOrderStatus_ItemCommand"
                                                        OnItemDataBound="rOrderStatus_ItemDataBound">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="linkEdit" Text="Edit" runat="server" CssClass="badge badge-primary"
                                            ...
                                            <div>
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="rfvDdkOrderStatus" 
                                                            ErrorMessage="Order Status is required" SetFocusOnError="true" display="dynamic"
                                                            InitialValue="0"
                                                            runat="server" ForeColor="Red" ControlToValidate="ddlOrderStatus">
