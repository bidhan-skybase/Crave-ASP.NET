<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Crave.Admin.Product" %>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    <label>Product Quantity(Rs)</label>
                                                    <div>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                                                            ErrorMessage="Quantity must not be negative" ForeColor="Red" Display="Dynamic"
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div>  
                                                        <asp:DropDownList ID="ddlCategories" CssClass="form-control" runat="server" 
                                                            AppendDataBoundItems="true" DataTextField="Name" DataValueField="CategoryId" DataSourceID="SqlDataSource1">
                                                    ...
                                                    <asp:Repeater ID="rProduct" runat="server" OnItemCommand="rProduct_ItemCommand"
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img alt="" width="40" src="<%# Crave.Utils.GetImageUrl(Eval("ImageUrl")) %>" />
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton 
                                                                        ...
                                                                        ID="linkEdit" Text="Edit" runat="server" CssClass="badge badge-primary"
                                                                    ...
                                                                    <asp:LinkButton ID="linkDelete"
                                                                        CausesValidation="false"
                                                                        Text="Delete" runat="server" CssClass="badge bg-danger"
