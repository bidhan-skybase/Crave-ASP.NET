            ...
            if (isValidToExecute)
            {
                ...
                try
                {
                    ...
                    actionName = userId == 0 ?
                        ...
                        "details updated successful ! <b><a href='Profile.aspx'>Click here</a><b>to Login";
                    lblMsg.Visible = true;
                ...
                {
                    if (ex.Message.Contains("Violation of UNIQUE KEY constratins"))
                    {
                        lblMsg.Visible = true;
                        lblMsg.Text = "<b>" + txtUsername.Text.Trim() + "</b> username already exists, try new one";
                        lblMsg.CssClass = "alert alrert-danger";
                    }
                }
                catch (Exception ex)
                {
