<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="Crave.User.Payment" %>
                        ...
                        <div class="card-footer">
                            ...
                            <div class="pt-1">
                                <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" ValidationGroup="card"
                                    HeaderText="" Font-Names="Segoe Script" />
                            </div>
                        </div>
                    </div>
                </div>
