<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="Crave.User.Profile" %>
                            ...
                            <div class="card-title mb-4">
                                <div class="d-flex justify-content-start">
                                    <div class="image-container">
                                        <img src="<%= Crave.Utils.GetImageUrl(imageUrl) %>" id="imgProfile" style="width:150px; height:150px;" 
                                            class="img-thumbnail" />
                    ...
                    <asp:Repeater runat="server" ID="rOrders">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label1" runat="server" Text='<%# string.IsNullOrEmpty(Eval("Price").ToString()) ? "" : " Rs. " + Eval("Price") %>'></asp:Label>
                                </td>
                                <td>
